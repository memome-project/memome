...
| Directory | Contents |
|-----------|----------|
| `corpus/` | **37 launch entries** — the interrogation-proof core. Every entry survived six adversarial reviews (Grok, OpenAI, Max, Claude, Perplexity, Gemini) with zero substantive flags. |
